...
const mk = (o) => ({
  ...
  bucket: "pkmn", name: "", set_name: "", number: "", variance: "Holofoil", grade: "",
...
export const DEMO_ROWS = [
  ...
  { name: "Giratina V (Alternate Full Art)", set_name: "Lost Origin", number: "186/196", price: 867.95,
  ...
  { name: "Dragonite", set_name: "Expedition", number: "9", price: 799.69,
    channel: "eBay (auction)", channel_reason: "scarce/chase — auction realizes above market",
    flags: ["ebay-authenticity-$250+", "tcgp-tracking-$50+", "scarce"], band: "o50", value_tier: "HIGH",
  ...
  { name: "Charizard", set_name: "Base Set (Unlimited)", number: "4", price: 720.34,
    channel: "eBay (auction)", channel_reason: "scarce/chase — auction realizes above market",
    flags: ["ebay-authenticity-$250+", "tcgp-tracking-$50+", "scarce"], band: "o50", value_tier: "HIGH",
  ...
  { name: "Espeon VMAX (Alternate Art Secret)", set_name: "Fusion Strike", number: "270/264", price: 345.42,
  ...
  { name: "Charizard ex", set_name: "SV: 151", number: "199/165", price: 406.14,
    channel: "eBay (auction)", flags: ["ebay-authenticity-$250+", "tcgp-tracking-$50+", "scarce"],
  ...
  { name: "Gengar ex", set_name: "Temporal Forces", number: "247/162", price: 69.23, qty: 3,
  ...
  { name: "Snorlax", set_name: "Lost Origin Trainer Gallery", number: "TG21/TG30", price: 25.04, qty: 4,
  ...
  { name: "Pikachu", set_name: "SV: 151", number: "173/165", price: 42.5,
    channel: "TCGplayer", band: "5_50", value_tier: "MID", card_class: "modern_textured",
    psa10: 127.5, psa10_x: 3.0, net_unit: 35.16, image_url: "https://images.pokemontcg.io/sv3pt5/173.png" },
  { name: "Bulbasaur", set_name: "SV: 151", number: "1/165", price: 3.42, qty: 2, variance: "Reverse Holofoil",
  ...
  { name: "Eevee", set_name: "Twilight Masquerade", number: "188/167", price: 91.41, condition: "LP",
  ...
  { name: "Sylveon ex (JP)", set_name: "Terastal Festival ex", number: "217/187", price: 147.33,
  ...
  // ── Filed piles ──
  { name: "Umbreon VMAX (Alternate Art Secret)", set_name: "Evolving Skies", number: "215/203", price: 420.0,
  ...
  { name: "Espeon VMAX (Alternate Art Secret)", set_name: "Evolving Skies", number: "214/203", price: 265.0,
  ...
  { name: "Mew ex", set_name: "SV: 151", number: "151/165", price: 34.02, tags: ["shop"],
    channel: "TCGplayer", band: "5_50", value_tier: "MID", card_class: "modern_textured",
    psa10: 102.06, psa10_x: 3.0, net_unit: 28.1, image_url: "https://images.pokemontcg.io/sv3pt5/151.png" },
  { name: "Alakazam ex", set_name: "SV: 151", number: "201/165", price: 88.0, tags: ["not-nm"],
    channel: "eBay (fixed)", flags: ["tcgp-tracking-$50+", "scarce"], band: "o50", value_tier: "MID",
  ...
  { bucket: "mtg", name: "The One Ring (Borderless)", set_name: "Universes Beyond: The Lord of the Rings", number: "0339",
    price: 89.5, variance: "Normal", channel: "eBay (fixed)", flags: ["tcgp-tracking-$50+"], band: "o50",
    value_tier: "MID", net_unit: 76.28,
    image_url: "https://api.scryfall.com/cards/named?format=image&version=normal&fuzzy=The%20One%20Ring" },
  { bucket: "mtg", name: "Blackblade Reforged", set_name: "Commander: Dominaria United", number: "120", price: 3.23,
    ...
    image_url: "https://api.scryfall.com/cards/named?format=image&version=normal&fuzzy=Blackblade%20Reforged" },
  // ── YGO ──
